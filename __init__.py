...
async def async_setup_entry(hass, entry):
    ...
    obico_component = ObicoComponent(hass, entry)  # Initialize ObicoComponent
    hass.data[DOMAIN][entry.entry_id] = obico_component  # Store ObicoComponent instance in data
